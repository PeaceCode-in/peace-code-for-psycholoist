...
import { Pill, Clock, RefreshCcw, BookMarked } from "lucide-react";

export const Route = createFileRoute("/prescriptions")({
  head: () => ({
    meta: [
      { title: "Prescriptions — PeaceCode · Practice" },
      { name: "description", content: "Medications on record — logged or prescribed. Titrations, discontinuations, letters, refills." },
    ],
  }),
...
const TABS = [
  { to: "/prescriptions", label: "Active", icon: Pill, exact: true },
  { to: "/prescriptions/reviews", label: "Reviews due", icon: Clock },
  { to: "/prescriptions/refills", label: "Refills", icon: RefreshCcw },
  { to: "/prescriptions/formulary", label: "Formulary", icon: BookMarked },
];
