...
import { Share2, TrendingUp, ArrowLeftRight } from "lucide-react";

export const Route = createFileRoute("/referrals")({
  head: () => ({
    meta: [
      { title: "Referrals — PeaceCode · Practice" },
      { name: "description", content: "Incoming and outgoing referrals — sources, urgency, conversion, warm handoff status." },
    ],
  }),
...
const TABS = [
  { to: "/referrals", label: "All", icon: ArrowLeftRight, exact: true },
  { to: "/referrals/sources", label: "Sources", icon: Share2 },
  { to: "/referrals/analytics", label: "Analytics", icon: TrendingUp },
];
        ...
        <div className="flex flex-wrap items-baseline justify-between gap-3 mb-4">
          <div>
            ...
            <p className="text-[12px] mt-1" style={{ color: palette.muted }}>
              GPs, psychiatrists, EAPs, universities, peers, self. Where your caseload actually comes from — and where it goes when a case isn't yours.
            </p>
          </div>
