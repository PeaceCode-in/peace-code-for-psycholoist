      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_260px] gap-5">
        <div className="space-y-5">
          ...
          <div className="rounded-2xl border p-5" style={{ borderColor: palette.border, background: palette.glassStrong, backdropFilter: "blur(14px)" }}>
            ...
            <div className="border rounded-lg p-4" style={{ borderColor: palette.border, background: palette.solid }}>
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border p-5 text-center" style={{ borderColor: palette.border, background: palette.glassStrong, backdropFilter: "blur(14px)" }}>
